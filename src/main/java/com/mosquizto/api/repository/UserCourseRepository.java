...
public interface UserCourseRepository extends JpaRepository<UserCourse, Long> {
    ...
    Optional<UserCourse> findActiveByUserIdAndCourseId(@Param("userId") Long userId, @Param("courseId") Long courseId);
    ...
    @Query(value = "SELECT uc FROM UserCourse uc " +
            ...
            countQuery = "SELECT COUNT(uc) FROM UserCourse uc " +
                    ...
                    "AND uc.user.deletedAt IS NULL " +
                    "AND uc.course.deletedAt IS NULL")
    Page<UserCourse> findActiveCoursesByUserIdAndStatus(
    ...
    @Query(value = "SELECT uc FROM UserCourse uc " +
            ...
            countQuery = "SELECT COUNT(uc) FROM UserCourse uc " +
                    ...
                    "AND uc.user.deletedAt IS NULL " +
                    "AND uc.course.deletedAt IS NULL")
    Page<UserCourse> findActiveMembersByCourseIdAndStatus(
